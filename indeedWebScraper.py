...
counts = {}
keywords = ['angular','angularjs','jquery','bigdata','googlecloud','ruby','agile','typescr>

def scrub(job, loc="Toronto", max_pages=2):
...
#       loc = loc.strip().replace(" ", "+") <<Just write inputs with + for now
        ...
        for page in range(0,max_pages):
                search="https://ca.indeed.com/jobs?q=" + job + "&l=" + loc + "&start=" + s>
                ...
                for link in soup.select('a[onmousedown*="rclk(this,jobmap"]'):
                        ...
                        for desc in subSOUP.find_all(name="div", attrs={"class":"jobsearch>
